...
- [x] Cookies - (components.ui.cookies.blade.php) - /cookies

- [x] Rating Overlay Card - (components.ui.rating-overlay-card.blade.php) - /rating-overlay-card

- [ ] search results - (search-results.blade.php) - /search-results
