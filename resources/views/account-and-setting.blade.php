            ...
            <div class="row">
                ...
                <div class="tabs-wrapper mb-5 mt-5" data-tabs>
                    <div class="tabs mt-5">
                        ...
                        <button class="tab-btn normal-font-weight d-flex align-items-center gap-10"
                            data-tab="account_linking">
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17"
                                fill="none">
                                <path
                                    d="M10.4981 1.61658C11.7528 0.356668 13.6854 0.254675 14.8155 1.38784C15.9457 2.52101 15.843 4.46263 14.5883 5.72254L12.7704 7.54715M6.63588 9.59976C5.50571 8.46584 5.60845 6.52498 6.86236 5.26582L8.4755 3.64668"
                                    stroke="#3B3731" stroke-width="1.2" stroke-linecap="round" />
                                <path
                                    d="M9.5659 6.59998C10.6953 7.73389 10.5933 9.67476 9.33866 10.9339L7.52079 12.7585L5.70292 14.5832C4.44826 15.8431 2.51565 15.9451 1.38548 14.8119C0.255312 13.6787 0.358054 11.7371 1.61271 10.4772L3.43059 8.65258"
                                    stroke="#3B3731" stroke-width="1.2" stroke-linecap="round" />
                            </svg>
                            Account Linking
                        </button>
                        <button class="tab-btn normal-font-weight d-flex align-items-center gap-10"
                            data-tab="data_and_legal">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="19" viewBox="0 0 15 19"
                                fill="none">
                                <path
                                    d="M7.5 0.599609C7.6159 0.599609 7.74865 0.62226 7.90137 0.677734L13.6572 2.82617C13.822 2.89351 13.9622 2.98868 14.082 3.11621L14.1963 3.25586C14.3323 3.44803 14.4003 3.65844 14.4004 3.90527V8.51562C14.4003 10.6471 13.8127 12.625 12.6309 14.4609C11.456 16.286 9.88134 17.5714 7.89453 18.332H7.89355C7.84043 18.3524 7.77884 18.369 7.70801 18.3809C7.63022 18.3939 7.56118 18.4004 7.5 18.4004C7.43964 18.4004 7.37031 18.394 7.29102 18.3809C7.25534 18.3749 7.22244 18.3684 7.19238 18.3604L7.10742 18.332L6.73926 18.1836C4.92392 17.409 3.4707 16.1721 2.36914 14.4609C1.18732 12.625 0.59968 10.6471 0.599609 8.51562V3.90527C0.599685 3.65844 0.667657 3.44803 0.803711 3.25586V3.25488C0.943976 3.05609 1.1187 2.91648 1.33691 2.82715L7.09961 0.676758L7.10059 0.677734C7.25215 0.622508 7.38419 0.599609 7.5 0.599609Z"
                                    stroke="#3B3731" stroke-width="1.2" />
                            </svg>
                            Data & Legal
                        </button>
                    ...
                    <div class="tab-panels mt-5">
                        ...
                        <div class="tab-panel" id="login_and_security">
                            ...
                            <div
                                class="settings-section-content d-flex flex-column justify-content-between mt-5 gap-25">
                                ...
                                <div class="user-sessions mt-5">
                                    <div class="logged-devices d-flex align-items-center justify-content-between mt-3">
                                        <div class="d-flex align-items-center gap-20">
                                            ...
                                            <p>Logged in on iPhone - <span style="color:#9D9B98">28/08/2025, 18:52
                                                    GMT</span></p>
                                        </div>
                                    ...
                                    <div class="logged-devices d-flex align-items-center justify-content-between mt-3">
                                        <div class="d-flex align-items-center gap-20">
                                            ...
                                            <p>Logged in on Web - <span style="color:#9D9B98">28/08/2025, 18:52
                                                    GMT</span></p>
                                        </div>
                                        <a href="" class="link-tag">Sign out</a>
                                    </div>
                                    ...
                                    <div class="logged-devices d-flex align-items-center justify-content-between mt-3">
                                        <div class="d-flex align-items-center gap-20">
                                            ...
                                            <p>Logged in on Android - <span style="color:#9D9B98">28/08/2025, 18:52
                                                    GMT</span></p>
                                        </div>
                                        <a href="" class="link-tag">Sign out</a>
                                    </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center gap-10">
                                        ...
                                        <p class="dark-color-font">Visa ending in 7890 | <span
                                                class="simple-light-font"> Exp. date 06/27</span></p>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center gap-10">
                                        <div style="width: 62px;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="33" height="20"
                                                ...
                                                <path d="M11.7742 2.13867H20.501V17.8609H11.7742V2.13867Z"
                                                    fill="#FF5F00" />
                                                <path
                                                    d="M12.3284 10C12.3284 6.8056 13.8243 3.97221 16.1237 2.13884C14.4339 0.805527 12.3007 0 9.97359 0C4.46029 0 0 4.47216 0 10C0 15.5278 4.46029 20 9.97347 20C12.3006 20 14.4338 19.1945 16.1237 17.861C13.8243 16.0555 12.3284 13.1944 12.3284 10Z"
                                                    fill="#EB001B" />
                                                <path
                                                    d="M32.2751 10C32.2751 15.5277 27.8148 20 22.3017 20C19.9745 20 17.8414 19.1945 16.1514 17.861C18.4786 16.0278 19.9469 13.1944 19.9469 10C19.9469 6.8056 18.4508 3.97221 16.1514 2.13884C17.8412 0.805527 19.9745 0 22.3017 0C27.8148 0 32.2751 4.49999 32.2751 10Z"
                                                    fill="#F79E1B" />
                                            </svg>
                                        </div>
                                        <p class="dark-color-font">Mastercard ending in 4589 | <span
                                                class="simple-light-font"> Exp. date 07/30</span></p>
                                    </div>
                                </div>
                                <a href="" class="small-link-tag">Edit</a>
                            </div>
                            ...
                            <table class="custom-table text-center mt-4">
                                ...
                                <tbody class="simple-font">
                                    <tr>
                                        ...
                                        <td>£76.00</td>
                                        <td><svg data-modal-open="invoice_modal" class="cursor"
                                                xmlns="http://www.w3.org/2000/svg" width="19" height="19"
                                                viewBox="0 0 19 19" fill="none">
                                                <path
                                                    d="M9.49609 15C11.4291 15 12.9961 13.433 12.9961 11.5C12.9961 9.567 11.4291 8 9.49609 8C7.5631 8 5.99609 9.567 5.99609 11.5C5.99609 13.433 7.5631 15 9.49609 15Z"
                                                    stroke="black" />
                                                <path
                                                    d="M18.4961 11.5C18.4961 11.5 17.4961 3.5 9.49609 3.5C1.49609 3.5 0.496094 11.5 0.496094 11.5"
                                                    stroke="black" />
                                            </svg></td>
                                        <td><svg data-modal-open="invoice_modal" class="cursor"
                                                ...
                                                <path
                                                    d="M0.5 15.5V17C0.5 17.3978 0.643751 17.7794 0.899456 18.0607C1.15516 18.342 1.50207 18.5 1.86372 18.5H14.1365C14.4982 18.5 14.8451 18.342 15.1008 18.0607C15.3565 17.7794 15.5 17.3978 15.5 17V15.5"
                                                    stroke="#3B3731" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M8 0.5V12.875M12.0909 8.75L8 13.25L3.90909 8.75"
                                                    stroke="#3B3731" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg></td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="modal" id="invoice_modal">
                                <div class="modal-content size">
                                    <div class="modal-head d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="cursor modal-cross" data-modal-close>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36"
                                                ...
                                                <path d="M12.8 23.9998L24 12.7998M12.8 12.7998L24 23.9998"
                                                    stroke="#3B3731" stroke-width="1.5" stroke-linecap="round" />
                                            </svg>
                                        </div>
                                    </div>
                                    <div class="modal-body">
                                        <div
                                            class="invoice-reference d-flex align-items-center justify-content-between">
                                                ...
                                                <p class="medium-light-font" style="color: #9D9B98;">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="19"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke-linejoin="round" />
                                                        <path
                                                            d="M7.99997 0.5V12.875M12.0909 8.75L7.99997 13.25L3.90906 8.75"
                                                            stroke="#3B3731" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                    </svg>
                                                </p>
                                        ...
                                        <div class="name-svg d-flex align-items-center gap-20 mt-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="36"
                                                ...
                                                <ellipse cx="17.3668" cy="18.0807" rx="10.2458" ry="9.64315"
                                                    fill="white" />
                                                <path
                                        ...
                                        <div class="serivce-name-price mt-1">
                                            <div class="service-name d-flex justify-content-between mt">
                                                <p class="medium-light-font">Full Groom <br> <span
                                                        class="simple-light-font">Bella</span></p>
                                        ...
                                        <div class="name-svg d-flex align-items-center gap-20 mt-3">
                                            ...
                                            <div>
                                                <p class="medium-font-bold">Sarah’s Grooming Studio</p>
                                                <p class="medium-light-font">Hosted by <span style="color: #9D9B98;">Dev
                                                        É.</span></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="serivce-name-price mt-1">
                                            <div class="service-name d-flex justify-content-between">
                                                <p class="medium-light-font">Garden / Shed <br> Half-Day (14:30 - 18:30)
                                                </p>
                        ...
                        <div class="tab-panel" id="privacy_and_permissions">
                            ...
                            <div
                                class="toggle-button-content d-flex align-items-center justify-content-between mt-5 mb-5">
                                <div class="d-flex flex-column gap-25">
                                    <p class="bold-font">Blocked Users</p>
                                    <p style="color: #9D9B98">You can block groomers/hosts or customers anytime from
                                        their profiles.</p>
                                </div>
                            </div>
                            ...
                            <div class="block-user-card d-flex align-items-center justify-content-between mt-4">
                                <div class="image-text d-flex align-items-center gap-10">
                                    ...
                                    <div>
                                        ...
                                        <span class="light-color-font">Includes other accounts they may have or
                                            create.</span>
                                    </div>
                                </div>
                                <div>
                        ...
                        <div class="tab-panel" id="account_linking">
                            ...
                            <div
                                class="settings-section-content d-flex flex-column justify-content-between mt-5 mb-5 gap-25">
                                <p class="bold-font">Connected Accounts</p>

                                <div class="d-flex align-items-center justify-content-between gap-25">
                                    <p style="color: #9D9B98">Link/unlink Google, Apple, or Facebook for login
                                        convenience</p>
                                </div>
                            </div>
                            ...
                            <div class="account-linking-card d-flex align-items-center justify-content-between mt-4">
                                <div class="image-text d-flex align-items-center gap-10">
                                    <div class="border-and-bg" style="border: none;">
                                        <img src="{{ asset('images/social_media/facebook.png') }}" class="social-icons"
                                            alt="">
                            ...
                            <div class="account-linking-card d-flex align-items-center justify-content-between mt-4">
                                <div class="image-text d-flex align-items-center gap-10">
                                    <div class="border-and-bg">
                                        <img src="{{ asset('images/social_media/google.png') }}" class="social-icons"
                                            alt="">
                            ...
                            <div class="account-linking-card d-flex align-items-center justify-content-between mt-4">
                                <div class="image-text d-flex align-items-center gap-10">
                                    <div class="border-and-bg">
                                        <img src="{{ asset('images/social_media/linkedin.png') }}" class="social-icons"
                                            alt="">
                            ...
                            <div class="account-linking-card d-flex align-items-center justify-content-between mt-4">
                                <div class="image-text d-flex align-items-center gap-10">
                                    <div class="border-and-bg">
                                        <img src="{{ asset('images/social_media/twitter.png') }}" class="social-icons"
                                            alt="">
                            ...
                            <div class="account-linking-card d-flex align-items-center justify-content-between mt-4">
                                <div class="image-text d-flex align-items-center gap-10">
                                    <div class="border-and-bg">
                                        <img src="{{ asset('images/social_media/apple.png') }}" class="social-icons"
                                            alt="">
