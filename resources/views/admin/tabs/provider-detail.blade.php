...
$pawfectProfile = [
    ...
    'services' => [
        ...
        ['name' => 'Puppy Intro', 'price' => '£35'],
    ],
    'pet_preferences' => [
        ['label' => 'Pet types accepted', 'value' => 'Dogs, Cats'],
        ['label' => 'Pet size preferences', 'value' => 'Small, Medium, Large'],
    ],
    'bookings' => [
...
foreach ($providers as $provider) {
    ...
    $providerProfiles[$provider['id']] = array_merge($pawfectProfile, [
        ...
        'insurance_class' => $provider['verified'] ? 'active' : 'suspended',
