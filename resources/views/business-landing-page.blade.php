        ...
        <section class="container">
            <div class="blp-hero">
                <div class="blp-hero-content">
                    <p class="blp-sub-text">→ Create something that's yours — structured, flexible, and built on your terms.
                    </p>
                    ...
                    <a href="{{ auth('groomer_spacer')->check() ? route('verify-qualify') : route('login-groomer-space') }}"
                        wire:navigate class="blp-btn">Get Started</a>
                </div>
            </div>
            ...
            <div class="blp-features-section">
                <div class="blp-container">
                    <div class="blp-feature-header">
                        ...
                        <p class="blp-feature-description">Choose your availability, decide who you work with,<br /> and
                            grow at
                            a
                            pace
                            that fits you.
                    ...
                    <div class="blp-features-grid">
                        <div class="blp-feature-item">
                            <div class="blp-icon"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="33"
                                    ...
                                    <path
                                        ...
                                        stroke="#3B3731" />
                                    <path d="M8.81195 2.94973V0.5M26.4555 2.94973V0.5M0.872375 11.1155H34.395"
                        ...
                        <div class="blp-feature-item">
                            ...
                            <p class="blp-des">Set size, age and handling preferences so you always work within your
                                confidence.
                            </p>
                        </div>
                        ...
                        <div class="blp-feature-item">
                            ...
                            <p class="blp-des">Manage bookings, availability, communication and payouts through a single,
                                simple
                                platform.</p>
                        </div>
                    </div>
                ...
                <div class="blp-process-container">
                    ...
                    <div class="blp-step-card">
                        <div class="blp-card-content">
                            ...
                            <p>Share your experience,<br> upload photos of your work, and introduce yourself professionally.
                            </p>
                        </div>
                        <div class="blp-card-footer">
                            <span>Step</span>
