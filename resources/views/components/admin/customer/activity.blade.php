...
'detail' => 'Session from New York, USA · Windows PC · IP 41.58.10.202',
'category' => 'account',
...
'date_label' => '18 APRIL 2025',
'group_note' => '',
'title' => 'Health flag added to pet profile',
'detail' => 'Flag: "Asthma — avoid aerosol sprays" added to Biscuit (Golden Retriever)',
'category' => 'pets',
'category_label' => 'Pets',
'reference' => 'PET-00231',
'admin' => 'Ben M',
...
'detail' => 'Full groom · Pawfect Salon · Biscuit · £55.00 charged · 4 stars',
'category' => 'bookings',
...
'date_label' => '18 APRIL 2025',
'group_note' => '',
'title' => 'Groomer payout placed on hold',
'detail' => 'Payout for FG-0563-B12 held pending dispute resolution',
'category' => 'payments',
'category_label' => 'Payments',
'reference' => 'INV-0563-B12',
'admin' => 'Michelle M',
'admin_key' => 'michelle',
'time' => '15:25',
'highlight' => false,
...
'detail' => 'Subject: "Groomer arrived late, service incomplete" · Bookings category',
'category' => 'support',
...
'detail' => 'Sarah M. signed up and booked using code JANE-XP44 · +£6.00 applied',
'category' => 'referrals',
'category_label' => 'Referrals',
'reference' => 'INV-0563-B15',
'admin' => 'System',
'admin_key' => 'system',
'time' => '18:50',
'highlight' => false,
...
'detail' => 'Signed up via Google · email jane.doe@gmail.com · London, UK',
'category' => 'account',
'category_label' => 'Account',
'reference' => 'USR-01452',
'admin' => 'Michelle M',
...
['key' => 'account', 'label' => 'Account', 'count' => 8],
['key' => 'pets', 'label' => 'Pets', 'count' => 5],
['key' => 'bookings', 'label' => 'Bookings', 'count' => 14],
['key' => 'payments', 'label' => 'Payments', 'count' => 9],
['key' => 'support', 'label' => 'Support', 'count' => 5],
['key' => 'referrals', 'label' => 'Referrals', 'count' => 4],
['key' => 'admin', 'label' => 'Admin Actions', 'count' => 12],
];
@endphp

<div
    class="admin-co-activity-tab"
    x-data="{
        events: @js($events),
        ...
        groupedEvents() {
            ...
            if (this.groupBy === 'category') {
                const order = ['account', 'pets', 'bookings', 'payments', 'support', 'referrals', 'admin'];
                return order.map((key) => {
                    const items = rows.filter((row) => row.category === key);
                    return {
                        key,
                        label: (items[0]?.category_label || '').toUpperCase(),
                        items,
                    };
        ...
        <div class="admin-co-act-menu">
            ...
            <div class="admin-co-act-panel" x-show="openMenu === 'admin'" x-cloak @click.stop>
                ...
                <button type="button" class="admin-co-act-option" :class="{ 'is-selected': admin === 'all' }" @click="admin = 'all'; openMenu = null">
                    <span class="admin-co-act-mark" :class="{ 'is-on': admin === 'all' }" aria-hidden="true">
                ...
                <button type="button" class="admin-co-act-option is-person" :class="{ 'is-selected': admin === 'jane' }" @click="admin = 'jane'; openMenu = null">
                    <span class="admin-co-act-mark" :class="{ 'is-on': admin === 'jane' }" aria-hidden="true">
                        <svg x-show="admin === 'jane'" xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                    ...
                    <span class="admin-co-act-option-label">Jane Doe <span class="admin-co-act-option-meta">(customer)</span></span>
                </button>
        ...
        <div class="admin-co-act-menu">
            ...
            <div class="admin-co-act-panel" x-show="openMenu === 'sort'" x-cloak @click.stop>
                ...
                <button type="button" class="admin-co-act-option" :class="{ 'is-selected': sortOrder === 'newest' }" @click="sortOrder = 'newest'">
                    <span class="admin-co-act-mark" :class="{ 'is-on': sortOrder === 'newest' }" aria-hidden="true">
                        <svg xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9" fill="none">
                            <path d="M0.75 4.48333L4.08333 7.75L10.75 0.75" stroke="#FFAF3B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                ...
                <button type="button" class="admin-co-act-option" :class="{ 'is-selected': sortOrder === 'oldest' }" @click="sortOrder = 'oldest'">
                    <span class="admin-co-act-mark" :class="{ 'is-on': sortOrder === 'oldest' }" aria-hidden="true">
                        <svg x-show="sortOrder === 'oldest'" xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                            <path d="M1 5.2L4.2 8.4L11 1.2" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                ...
                <button type="button" class="admin-co-act-option" :class="{ 'is-selected': groupBy === 'date' }" @click="groupBy = 'date'">
                    <span class="admin-co-act-mark" :class="{ 'is-on': groupBy === 'date' }" aria-hidden="true">
                        <svg xmlns="http://www.w3.org/2000/svg" width="12" height="9" viewBox="0 0 12 9" fill="none">
                            <path d="M0.75 4.48333L4.08333 7.75L10.75 0.75" stroke="#FFAF3B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                ...
                <button type="button" class="admin-co-act-option" :class="{ 'is-selected': groupBy === 'category' }" @click="groupBy = 'category'">
                    <span class="admin-co-act-mark" :class="{ 'is-on': groupBy === 'category' }" aria-hidden="true">
                        <svg x-show="groupBy === 'category'" xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                            <path d="M1 5.2L4.2 8.4L11 1.2" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                ...
                <button type="button" class="admin-co-act-option" :class="{ 'is-selected': groupBy === 'none' }" @click="groupBy = 'none'">
                    <span class="admin-co-act-mark" :class="{ 'is-on': groupBy === 'none' }" aria-hidden="true">
                        <svg x-show="groupBy === 'none'" xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                            <path d="M1 5.2L4.2 8.4L11 1.2" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
