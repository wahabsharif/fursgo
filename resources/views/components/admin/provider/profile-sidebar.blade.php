                ...
                <div class="admin-co-blocked-modal-body admin-co-verify-email-body">
                    <div class="admin-co-verify-email-card">
                        ...
                        <div class="admin-co-blocked-body">
                            ...
                            <p class="admin-co-verify-email-address">{{ $providerEmail }}</p>
                        </div>
                    </div>

                    <p class="admin-co-verify-email-copy">
                        A password reset link will be sent to the provider's registered email address. For security reasons, you cannot customise the email content or see the reset link.
                    </p>
                    ...
                    <div class="admin-co-verify-email-happens">
                        ...
                        <ul class="admin-co-verify-email-happens-list">
                            <li>Reset your password email will be sent to <span class="admin-co-verify-email-link">{{ $providerEmail }}</span></li>
            ...
            <div class="admin-co-modal admin-co-verify-email-modal admin-co-suspend-modal" role="dialog" aria-modal="true" @click.stop>
                ...
                <div class="admin-co-blocked-modal-body admin-co-verify-email-body">
                    ...
                    <div class="admin-co-verify-email-happens">
                        <h4 class="admin-co-verify-email-happens-title">What happens</h4>
                        <ul class="admin-co-verify-email-happens-list">
                            <li>Provider will lose access to their account immediately</li>
                            <li>Upcoming bookings and payouts are paused — customers are notified</li>
                            <li>Provider will receive a suspension notification email</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="admin-co-modal admin-co-verify-email-modal admin-co-suspend-modal" role="dialog" aria-modal="true" @click.stop>
                ...
                <div class="admin-co-blocked-modal-body admin-co-verify-email-body">
                    <div class="admin-co-suspend-alert is-info">
                        ...
                        <p>Flagging is internal only — the provider is not notified. A flag marks the account for follow-up review and appears as an amber indicator on the provider's profile.</p>
                    </div>
            ...
            <div class="admin-co-modal admin-co-verify-email-modal admin-co-suspend-modal" role="dialog" aria-modal="true" @click.stop>
                ...
                <div class="admin-co-blocked-modal-body admin-co-verify-email-body">
                    <div class="admin-co-suspend-alert is-danger">
                        ...
                        <p>This permanently removes {{ $firstName }} from the platform — profile, bookings, payout history, services, messages and reviews. This cannot be reversed. Only proceed if you have a valid GDPR deletion request.</p>
                    </div>
                    ...
                    <div class="admin-co-delete-user-card">
                        ...
                        <div class="admin-co-blocked-body">
                            ...
                            <p class="admin-co-delete-user-meta">{{ $providerEmail }} · {{ $profile['id'] }}@if ($memberSince) · joined {{ $memberSince }}@endif</p>
                        </div>
                    </div>
                    ...
                    <div class="admin-co-suspend-field">
                        ...
                        <div class="admin-co-dd admin-co-suspend-dd" @click.outside="openDeleteReason = false">
                            ...
                            <div class="admin-co-dd-menu" x-show="openDeleteReason" x-cloak>
                                ...
                                <button type="button" class="admin-co-dd-option" :class="{ 'is-active': deleteReason === 'Fraud or serious policy breach' }" @click="deleteReason = 'Fraud or serious policy breach'; openDeleteReason = false">Fraud or serious policy breach</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="admin-co-verify-email-happens">
                        ...
                        <ul class="admin-co-verify-email-happens-list">
                            <li>Business profile, photo and all personal details</li>
                            <li>All booking history and associated messages</li>
                            <li>Services, location types and pet preferences</li>
                            <li>Payout history and bank details</li>
                            <li>Reviews received for this provider</li>
