@if ($isBusinessSiteRoute && !$isBusinessHomepageRoute)
    <header class="header-business-public">
        <nav class="navbar">
            <div class="header-business-public-inner">
                <div class="logo-toggle-button header-business-public-brand">
                    <a href="{{ $businessHomepageUrl }}" wire:navigate class="header-business-public-logo"
                        aria-label="FursGo Business">
                        <span class="header-business-public-logo-mark" aria-hidden="true">
                            <img src="{{ asset('images/header/logo-fursgo.svg') }}" alt="" width="98" height="27">
                        </span>
                        <span class="header-business-public-logo-pill">Business</span>
                    </a>
                    <button type="button" class="menu-toggle" aria-label="Toggle menu">&#9776;</button>
                </div>
                <ul class="menu-items header-business-public-nav">
                    <li>
                    ...
                    <li class="header-business-public-nav-auth">
                        <div class="login-signup-div">
                            <a href="{{ $loginGroomerSpaceUrl }}" class="login-btn" wire:navigate>Log in</a>
                            <a href="{{ $signupGroomerSpaceUrl }}" class="signup-btn active" wire:navigate>Sign Up</a>
                        </div>
                    </li>
                </ul>
                <div class="header-business-public-auth">
                    <div class="login-signup-div">
                        <a href="{{ $loginGroomerSpaceUrl }}" class="login-btn" wire:navigate>Log in</a>
                        <a href="{{ $signupGroomerSpaceUrl }}" class="signup-btn active" wire:navigate>Sign Up</a>
                    </div>
    ...
    <style>
        ...
        .header-business-public nav,
        .header-business-public nav.navbar {
            display: block;
            min-height: 85px;
            padding: 0 !important;
            background: #fff;
        ...
        .header-business-public-logo-mark {
            width: 98px;
            height: 27px;
            flex-shrink: 0;
            overflow: clip;
        ...
        .header-business-public-logo-mark img {
            width: 98px;
            height: 27px;
            display: block;
        }

        .header-business-public-logo-pill {
            display: inline-flex;
            align-items: center;
        ...
        .header-business-public-nav a::after {
            content: "";
            position: absolute;
            left: 0;
            right: 0;
        ...
        .header-business-public-nav a:hover,
        .header-business-public-nav a.active {
            color: #ffc97a;
            font-weight: 600;
            text-decoration: none;
        }

        .header-business-public-nav a:hover::after,
        .header-business-public-nav a.active::after {
            transform: scaleX(1);
        }

        .header-business-public-nav-auth {
            display: none;
        }

        .header-business-public-auth {
            justify-self: end;
        }

        .header-business-public .login-signup-div {
            display: flex;
            align-items: center;
            gap: 20px;
        }

        .header-business-public .login-btn,
        .header-business-public .signup-btn {
            display: inline-flex;
            align-items: center;
            justify-content: center;
            box-sizing: border-box;
        ...
        .header-business-public .login-btn:hover {
            color: #fff;
            background: #3b3731;
            border-color: #3b3731;
        ...
        .header-business-public .signup-btn,
        .header-business-public .signup-btn.active {
            min-width: 102px;
            color: #fff;
            background: #ffc97a;
            border: none;
        ...
        .header-business-public .signup-btn:hover,
        .header-business-public .signup-btn.active:hover {
            color: #fff;
            background: #f5b56a;
            transform: translateY(-1px);
        ...
        .header-business-public .menu-toggle {
            display: none;
            background: none;
            border: 0;
            padding: 0;
