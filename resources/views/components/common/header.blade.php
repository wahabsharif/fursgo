...
@if ($variant === 'dashboard')
    ...
    <header class="dashboard-header">
        ...
        <div class="dashboard-header-container">
                    ...
                    <div class="align-items-center dash-menu-items">
                        <div class="logo-toggle-button d-flex justify-content-between">
                            <a href="{{ route('dashboard') }}" wire:navigate
                                @click="activeSection = 'business-hub'; bookingsOpen = false; availabilityOpen = false; showDashboardHub()"
                        ...
                        <div>
                            @if ($variant === 'dashboard')
                                <a href="{{ route('business-homepage-groomer-space-owner') }}"
                                    @click.prevent="showDashboardInfoView('for-groomers-hosts')"
                                    :class="{ 'active': dashboardNavView === 'for-groomers-hosts' }">For Groomers &
                                    Hosts</a>
                                <a href="{{ route('help-and-support') }}"
                                    @click.prevent="showDashboardInfoView('help-centre')"
                                    :class="{ 'active': dashboardNavView === 'help-centre' }">Help Centre</a>
            ...
            {{-- Welcome Section (hub) or For Groomers / Help Centre content --}}
            <div class="welcome-section" :class="{ 'welcome-section--info': dashboardNavView !== 'hub' }">
                <div class="welcome-hub-content" x-show="dashboardNavView === 'hub'" x-cloak>
                    <div class="dashboard-header-inner">
                                        ...
                                        @if (auth()->check() && auth()->user()->user_type === 'space')
                                            <svg xmlns="http://www.w3.org/2000/svg" width="29" height="31"
                                                ...
                                                <path
                                                    ...
                                                    fill="#CBDCE8" />
                                                <path
                                                    d="M9.55615 18.8365C9.55615 18.8365 11.4983 19.2125 13.4405 17.7131"
                                                    stroke="white" stroke-linecap="round" stroke-linejoin="round" />
                                                <path
                                                ...
                                                <path d="M14.6052 9.16699V9.24468" stroke="white"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        @else
                ...
                <div class="welcome-info-content" x-show="dashboardNavView === 'for-groomers-hosts'" x-cloak>
                    <x-dashboard.for-groomers-hosts />
                </div>

                <div class="welcome-info-content" x-show="dashboardNavView === 'help-centre'" x-cloak>
        ...
        <style>
            ...
            .dashboard-header:has(.welcome-section--info) {
                overflow-x: visible;
            }

            .dashboard-header:has(.welcome-section--info) .dashboard-header-container {
                overflow-x: visible;
            }

            .welcome-section--info .dashboard-info-panel--for-groomers,
            .welcome-section--info .dashboard-info-panel--help-centre {
                width: 100%;
            }

            .welcome-section--info .container {
                margin-left: auto;
                margin-right: auto;
            }
