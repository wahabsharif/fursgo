                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-8">
                            <ul class="menu-items">
                                ...
                                <li>
                                    <div
                                        class="session-login-signup-div dashboard-header-icons d-flex align-items-center gap-40">
                                        <div class="messages-content-tab">
                                            ...
                                            <div class="messages-notifications" style="display: none;">
                                                ...
                                                <div class="header-notifications-div">
                                                    ...
                                                    <div
                                                        class="chat-card cursor d-flex align-items-center gap-20 mt-4">
                                                                ...
                                                                <div class="top-left-svg">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        ...
                                                                        <path d="M10.0268 6.29364V6.34698V6.29364Z"
                                                                            fill="#CBDCE8" />
                                                                        <path d="M10.0268 6.29364V6.34698"
                                                                            stroke="white" stroke-linecap="round"
                                                                            stroke-linejoin="round" />
                                                                    </svg>
                                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center gap-10">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                            height="16" viewBox="0 0 16 16" fill="none">
                                                            <path d="M5.1875 7.0625L8 9.875L15.5 2.375"
                                        ...
                                        <div class="notification-content-tab">
                                            ...
                                            <div class="header-notifications" style="display: none;">
                                                ...
                                                <div class="header-notifications-div">
                                                    <div
                                                        class="header-notifications-list booking-confirmed cursor mt-4">
                                                        <div
                                                    ...
                                                    <div
                                                        class="header-notifications-list booking-reminder cursor mt-4">
                                                        <div
                                                            class="header-notification-list-item d-flex align-items-center justify-content-between">
                                                            <div
                                                                class="notification-list-item-inner-left d-flex align-items-center">
