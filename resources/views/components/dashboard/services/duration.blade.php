...
<div class="service-fieldset service-duration-fieldset" x-data="{
    ...
    <div class="service-form-grid">
        <label class="service-field">
            ...
            <x-dashboard.services.duration-select model="baseDuration" open-key="openBaseDuration" :options="$baseDurationOptions" />
        </label>

        <label class="service-field">
            <span style="color: #9D9B98;">Buffer Time (after service)</span>
            <x-dashboard.services.duration-select model="bufferTime" open-key="openBufferTime" :options="$bufferTimeOptions"
        ...
        <div class="service-duration-by-size">
            ...
            <div class="service-duration-by-size-card">
                <div class="service-duration-by-size-row">
                    <p>Small 0-7 kg</p>
                    <x-dashboard.services.duration-select model="durationSmall" open-key="openDurationSmall"
                        :options="$smallDurationOptions" :by-size="true" />
                </div>

                <div class="service-duration-by-size-row">
                    <p>Medium 8-18 kg</p>
                    <x-dashboard.services.duration-select model="durationMedium" open-key="openDurationMedium"
                ...
                <div class="service-duration-by-size-row">
                    <p>Large 19+ kg</p>
                    @if ($largeMode === 'dropdown')
                        <x-dashboard.services.duration-select model="durationLarge" open-key="openDurationLarge"
