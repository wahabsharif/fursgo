...
<!-- In any Blade view, e.g., .blade.php -->
<x-ui.groomer-tab-card-view :groomers="[
    [
        'name' => 'Sarah W.',
    ...
    [
        ...
        'tags' => ['Salon Visit', 'Spa Package'],
        'slots' => ['Wed 5, 10:00 AM', 'Fri 7, 02:00 PM'],
        'is_top_rated' => false,
    ],
    [
        'name' => 'Cathy P.',
        ...
        'tags' => ['Home Visit', 'Mobile Station', 'Senior Dog Specialist'],
        'slots' => ['Mon 8, 09:00 AM', 'Tue 9, 11:30 AM', 'Thu 11, 01:00 PM'],
        'is_top_rated' => true,
    ]
]" />
            ...
            <div class="right">
                <div class="top-row">
                    <div class="tags" aria-hidden="true">
                        ...
                        $tags = $groomer['tags'] ?? [];
                        if (is_string($tags)) {
                        // Try JSON decode first, then fallback to comma separation
                ...
                <div class="studio-details mt-1 d-flex align-items-center justify-content-between">
                    ...
                    <div class="meta d-flex align-items-center justify-content-between">
                        ...
                        <div class="rating" title="Rating">
                            ...
                            <span>{{ $groomer['rating'] }} <small style="color:var(--muted)">({{ $groomer['reviews_count'] }})</small></span>
                        </div>
                    </div>
                </div>

                <p class="experience">{{ $groomer['experience_text'] }}</p>
