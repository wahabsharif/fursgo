{{-- Space venue + sort. Values match card tags used by customer_journey.js --}}
@props([
    'selectedFilters' => [],
    'venues' => [
        ['label' => 'Private rooms', 'value' => 'Private rooms'],
        ['label' => 'Salon', 'value' => 'Salon'],
        ['label' => 'Mobile station', 'value' => 'Mobile station'],
        ['label' => 'Garden / Shed', 'value' => 'Garden / Shed'],
...
<div class="col-lg-12 section-gap">
    <div class="selection-box d-flex justify-content-between">
        <div class="selected-item-section d-flex align-items-center flex-wrap" id="spaceSelectedSection"
                            ...
                            @foreach ($venues as $venue)
                                <li>
                                    <label>
                                        ...
                                        <input type="checkbox" name="space-venue[]" value="{{ $venue['value'] }}"
                            ...
                            @foreach ($sortOptions as $sort)
                                <li>
                                    <label>
                                        ...
                                        <input type="radio" name="space-sort" value="{{ $sort['value'] }}"
