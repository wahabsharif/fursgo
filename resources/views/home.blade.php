                                                ...
                                                <div class="pet-toggle">
                                                    <button type="button" class="pet-option" data-pet="cat">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                            height="23" viewBox="0 0 16 23" fill="none">
                                                            <path
                                                    ...
                                                    <button type="button" class="pet-option highlight"
                                                        data-pet="other">
                                                        <span>Other</span>
                                                            ...
                                                            <div style="display:flex;">
                                                                ...
                                                                <div class="time-col">
                                                                    ...
                                                                    <div class="time-list" id="timeList"
                                                                        role="listbox" aria-label="Time options">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="how-it-works-grid section">
                    ...
                    <div class="how-step">
                        <div class="how-it-works-image-content-area">
                            <div class="search-image">
                                <img src="{{ asset('images/search.png') }}" class="how-it-works-images"
                                    alt="">
                            </div>
                            <div class="numbering">
                                <span>1</span>
                    ...
                    <div class="how-down-arrow">
                        <svg xmlns="http://www.w3.org/2000/svg" width="171" height="26" viewBox="0 0 171 26"
                            fill="none">
                            <path d="M0.558105 24.9469C27.4847 6.83593 98.982 -18.5194 169.558 24.9469"
                                stroke="#3B3731" stroke-width="2" stroke-dasharray="10 10" />
                        </svg>
                    </div>
                    ...
                    <div class="how-step">
                        <div class="how-it-works-image-content-area">
                            <div class="relax-content">
                                <img src="{{ asset('images/relax.png') }}" class="how-it-works-images"
                                    alt="">
                            </div>
                            <div class="numbering">
                                <span>3</span>
    ...
    <script>
        function initScrollReveal() {
            const revealTargets = document.querySelectorAll(
                '.hero-section, .rating-section, .section, .testimonial-section, .how-it-works'
            );
            ...
            revealTargets.forEach((el) => el.classList.add('scroll-reveal-target'));
            ...
            <div class="our-mission row d-flex justify-content-center align-items-center">
                <div class="col-lg-7">
                    <div class="image-wrapper">
                        <img src="{{ asset('images/our_mission.png') }}" alt=""
                    ...
                    <div class="fursgo-address-map">
                        ...
                        <div class="fursgo-map-image-wrapper">
                            <img src="{{ asset('images/Intersect.png') }}" alt=""
                                style="border-bottom-right-radius: 10%;">
                        </div>
                    </div>
                </div>
            </div>
