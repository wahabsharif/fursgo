    ...
    public function getStats()
    {
        ...
        return [
            ...
            'profile_views' => [
                ...
                'sublabel' => $completedBookings . ' bookings from views',
            ],
            'repeat_clients' => [
                'value' => $repeatClients,
...
<div x-data="{ activeTab: @entangle('activeTab') }" class="business-hub-container" wire:loading.class="business-hub-container--navigating"
    ...
    <div class="dashboard-bottom-row">
                            ...
                            @if ($isSpaceAccount)
                                ...
                                <div class="pet-section">
                                    <div class="pet-info">
                                        ...
                                        <span class="pet-types">{{ $booking['pet_type'] }} <span
                                                class="black-dot"></span>
                                            {{ $booking['weight'] }}</span>
                                    </div>
                                </div>
                            @else
        ...
        <div class="stats-column">
            ...
            <!-- Avg. Revenue / Space Profile Views -->
            <div class="dashboard-card stat-card">
                <div class="stat-header">
                    <h4>{{ $isSpaceAccount ? 'Space Profile Views' : 'Avg. Revenue' }}</h4>
                </div>
                <div class="stat-body">
                    <div class="stat-main">
                        @if ($isSpaceAccount)
                                            ...
                                            @else
                                                <div class="detail-row">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"
                                                        ...
                                                        <circle cx="50" cy="50" r="42" stroke="#2f2c28"
                                                            stroke-width="7" />
                                                        <line x1="50" y1="50" x2="50"
                                                            y2="28" stroke="#2f2c28" stroke-width="8"
                                                            stroke-linecap="round" />
                                                        <line x1="50" y1="50" x2="70"
                                                            y2="70" stroke="#2f2c28" stroke-width="8"
                                                            stroke-linecap="round" />
                                                        <circle cx="50" cy="50" r="3.5" fill="#2f2c28" />
                                                    </svg>
                                                    <span>{{ $booking['time'] }}</span>
                                                    ...
                                                    <div class="detail-row">
                                                        ...
                                                        @else
                                                            <svg width="16" height="16" viewBox="0 0 16 16"
                                                                ...
                                                                <path d="M8 4.5V8L10.5 10" stroke="#3B3731"
                                            ...
                                            @else
                                                <div class="pet-section">
                                                    ...
                                                    <div class="pet-info">
                                                        ...
                                                        <span
                                                            class="pet-types">{{ implode(', ', $booking['pets']) }}</span>
                                                    </div>
                                                </div>
                                                <div class="booking-body-divider"></div>
                                                <div class="info-cell">
