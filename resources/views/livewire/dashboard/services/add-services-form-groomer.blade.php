...
<section class="service-form-wrapper" aria-label="Add service form" x-data="{ selectedPets: ['cat', 'other'], selectedSizes: ['small', 'medium'], baseDuration: '90 Minutes', bufferTime: '15 min', durationSmall: '15 min', durationMedium: '30 min', basePrice: 35, priceSmall: 35, priceMedium: 45, overtimeCharge: 10, overtimePer: '15 min' }">
    <form class="service-form" action="#" method="post" @submit.prevent>
        <div class="service-form-grid">
            <label class="service-field" style="width: 400px;">
                <span>Service Name</span>
                <input type="text" placeholder="Full Groom" />
            </label>
        ...
        <div class="service-fieldset">
            ...
            <div class="service-chip-row">
                ...
                <div>
                    <span>Pet Size</span>
                    <div>
                        <button type="button" class="service-chip service-chip"
        ...
        <div class="service-fieldset">
            ...
            <div class="service-form-grid">
                <label class="service-field">
                    ...
                    <div class="service-custom-select" :class="{ 'is-open': open }" x-data="{ open: false }"
                        @keydown.escape.window="open = false">
                        <button type="button" class="service-custom-trigger" @click="open = !open"
                            :aria-expanded="open.toString()">
                            <span x-text="baseDuration"></span>
                        ...
                        <div class="service-custom-menu" x-cloak x-show="open" @click.outside="open = false"
                            ...
                            <button type="button" class="service-custom-option"
                                :class="{ 'is-active': baseDuration === '90 Minutes' }"
                                @click="baseDuration = '90 Minutes'; open = false">
                                <span>90 Minutes</span>
                            </button>
                            <button type="button" class="service-custom-option"
                                :class="{ 'is-active': baseDuration === '60 Minutes' }"
                                @click="baseDuration = '60 Minutes'; open = false">
                                <span>60 Minutes</span>
                            </button>
                            <button type="button" class="service-custom-option"
                                :class="{ 'is-active': baseDuration === '30 Minutes' }"
                                @click="baseDuration = '30 Minutes'; open = false">
                ...
                <label class="service-field">
                    ...
                    <div class="service-custom-select" :class="{ 'is-open': open }" x-data="{ open: false }"
                        ...
                        <div class="service-custom-menu" x-cloak x-show="open" @click.outside="open = false"
                            ...
                            x-transition:leave-end="service-custom-menu-leave-end">
                            <button type="button" class="service-custom-option"
                                :class="{ 'is-active': bufferTime === '15 min' }"
                                @click="bufferTime = '15 min'; open = false">
                                <span>15 min</span>
                            </button>
                            <button type="button" class="service-custom-option"
                                :class="{ 'is-active': bufferTime === '10 min' }"
                                @click="bufferTime = '10 min'; open = false">
                                <span>10 min</span>
                            </button>
                            <button type="button" class="service-custom-option"
                                :class="{ 'is-active': bufferTime === '5 min' }"
                                @click="bufferTime = '5 min'; open = false">
                                <span>5 min</span>
                            </button>
                        </div>
                    </div>
                ...
                <div class="service-duration-by-size-card">
                    <div class="service-duration-by-size-row">
                        ...
                        <div class="service-custom-select service-custom-select-duration" :class="{ 'is-open': open }"
                            ...
                            <button type="button" class="service-custom-trigger" @click="open = !open"
                                :aria-expanded="open.toString()">
                                <span x-text="durationSmall"></span>
                            ...
                            <div class="service-custom-menu" x-cloak x-show="open" @click.outside="open = false"
                                ...
                                x-transition:leave-end="service-custom-menu-leave-end">
                                <button type="button" class="service-custom-option"
                                    :class="{ 'is-active': durationSmall === '15 min' }"
                                    @click="durationSmall = '15 min'; open = false">
                                    <span>15 min</span>
                                </button>
                                <button type="button" class="service-custom-option"
                                    :class="{ 'is-active': durationSmall === '20 min' }"
                                    @click="durationSmall = '20 min'; open = false">
                                    <span>20 min</span>
                                </button>
                                <button type="button" class="service-custom-option"
                                    :class="{ 'is-active': durationSmall === '30 min' }"
                                    @click="durationSmall = '30 min'; open = false">
                                    <span>30 min</span>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="service-duration-by-size-row">
                        ...
                        <div class="service-custom-select service-custom-select-duration" :class="{ 'is-open': open }"
                            ...
                            <button type="button" class="service-custom-trigger" @click="open = !open"
                                :aria-expanded="open.toString()">
                                <span x-text="durationMedium"></span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="11" height="6"
                                    viewBox="0 0 11 6" fill="none">
                                    <path d="M10.3741 0.5L5.39527 5.47882L0.500024 0.583578" stroke="#3B3731"
                                        stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <div class="service-custom-menu" x-cloak x-show="open" @click.outside="open = false"
                                ...
                                x-transition:leave-end="service-custom-menu-leave-end">
                                <button type="button" class="service-custom-option"
                                    :class="{ 'is-active': durationMedium === '20 min' }"
                                    @click="durationMedium = '20 min'; open = false">
                                    <span>20 min</span>
                                </button>
                                <button type="button" class="service-custom-option"
                                    :class="{ 'is-active': durationMedium === '30 min' }"
                                    @click="durationMedium = '30 min'; open = false">
                                    <span>30 min</span>
                                </button>
                                <button type="button" class="service-custom-option"
                                    :class="{ 'is-active': durationMedium === '45 min' }"
                                    @click="durationMedium = '45 min'; open = false">
                                    <span>45 min</span>
                                </button>
                            </div>
                        </div>
        ...
        <div class="service-fieldset">
            ...
            <div class="service-price-layout">
                <div class="service-price-by-size">
                    ...
                    <div class="service-price-by-size-card">
                        <div class="service-price-by-size-row">
                            ...
                            <div class="service-number-input-wrap service-number-input-wrap-currency"
                                style="width: 85px;">
                                <input type="number" min="0" step="0.01" x-model="priceSmall"
                                    style="width: 100%;" />
                                <div class="service-number-input-controls">
                                    <button type="button" class="service-number-step-btn"
                                        aria-label="Increase small pet price"
                                        @click="$event.currentTarget.closest('.service-number-input-wrap').querySelector('input').stepUp(); $event.currentTarget.closest('.service-number-input-wrap').querySelector('input').dispatchEvent(new Event('input', { bubbles: true }))">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="11" height="6"
                                            viewBox="0 0 11 6" fill="none">
                                    ...
                                    <button type="button" class="service-number-step-btn"
                                        aria-label="Decrease small pet price"
                                        @click="$event.currentTarget.closest('.service-number-input-wrap').querySelector('input').stepDown(); $event.currentTarget.closest('.service-number-input-wrap').querySelector('input').dispatchEvent(new Event('input', { bubbles: true }))">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="11" height="6"
                                            viewBox="0 0 11 6" fill="none">
                                            <path d="M10.3741 0.5L5.39527 5.47882L0.500024 0.583578" stroke="#3B3731"
                        ...
                        <div class="service-price-by-size-row">
                            ...
                            <div class="service-number-input-wrap service-number-input-wrap-currency"
                                ...
                                <input type="number" min="0" step="0.01"
                                    x-model="priceMedium"style="width: 100%;" />
                                <div class="service-number-input-controls">
                                    <button type="button" class="service-number-step-btn"
                                        aria-label="Increase medium pet price"
                                        @click="$event.currentTarget.closest('.service-number-input-wrap').querySelector('input').stepUp(); $event.currentTarget.closest('.service-number-input-wrap').querySelector('input').dispatchEvent(new Event('input', { bubbles: true }))">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="11" height="6"
                                            viewBox="0 0 11 6" fill="none">
                                            <path d="M10.3741 5.47876L5.39527 0.499941L0.500024 5.39518"
                                    ...
                                    <button type="button" class="service-number-step-btn"
                                        aria-label="Decrease medium pet price"
                                        @click="$event.currentTarget.closest('.service-number-input-wrap').querySelector('input').stepDown(); $event.currentTarget.closest('.service-number-input-wrap').querySelector('input').dispatchEvent(new Event('input', { bubbles: true }))">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="11" height="6"
                                            viewBox="0 0 11 6" fill="none">
                                            <path d="M10.3741 0.5L5.39527 5.47882L0.500024 0.583578" stroke="#3B3731"
                ...
                <div class="service-overtime-wrap">
                    <label class="service-field">
                        <span style="color: #9D9B98;font-weight: 400;">Overtime charges</span>
...
<style>
    ...
    .service-duration-advanced-wrap {
        display: flex;
        align-items: flex-end;
        padding-bottom: 0.4rem;
    }

    .service-duration-advanced-btn {
        border: 0;
    ...
    .service-duration-advanced-btn span:last-child {
        text-decoration-line: underline;
        text-underline-offset: 4px;
    }

    .service-duration-by-size {
        margin-top: 2rem;
        width: 28%;
    }

    .service-duration-by-size-head {
        display: grid;
    ...
    .service-duration-by-size-head p {
        margin: 0;
        color: #1F1F1F;
        font-family: Lato;
        font-size: 16px;
    ...
    .service-duration-by-size-row p {
        margin: 0;
        color: #000;
        font-family: Lato;
        font-size: 16px;
    ...
    .service-price-by-size {
        width: 422px;
    }

    .service-price-by-size-head {
        display: grid;
    ...
    .service-price-by-size-row input {
        width: 100%;
        height: 42px;
        border-radius: 10px;
        border: 1px solid #DDD;
