<div class="row mt-5">
    ...
    <div class="col-lg-10">
        <div class="submit-chat-box d-flex align-items-center justify-content-center mt-5 gap-30">
            ...
            <!-- Attachment / submit JS: public/js/help-support.js -->
            ...
            <!-- Review submitted Modal helpers: public/js/help-support.js -->

            <div class="chat-with-fursgo box-wrapper d-flex flex-column align-items-center justify-content-center gap-20">
